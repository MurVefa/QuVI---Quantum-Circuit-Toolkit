	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Gates" Type="Folder">
			<Item Name="Polymorphs" Type="Folder">
				...
				<Item Name="Pauli-Z_s.vi" Type="VI" URL="../Gates/Polymorphs/Pauli-Z_s.vi"/>
				<Item Name="Pauli-Z_t.vi" Type="VI" URL="../Gates/Polymorphs/Pauli-Z_t.vi"/>
		...
		<Item Name="QuSim" Type="Folder">
			...
			<Item Name="QuVI_Wire.vi" Type="VI" URL="../QuSim/QuVI_Wire.vi"/>
			<Item Name="QuVI_Wire (initial).vi" Type="VI" URL="../QuSim/QuVI_Wire (initial).vi"/>
			<Item Name="QuVI_Wire (added).vi" Type="VI" URL="../QuSim/QuVI_Wire (added).vi"/>
		</Item>
		<Item Name="Examples" Type="Folder">
			...
			<Item Name="QFT-4Q.vi" Type="VI" URL="../Examples/QFT-4Q.vi"/>
			<Item Name="QKD-BB84.vi" Type="VI" URL="../Examples/QKD-BB84.vi"/>
			<Item Name="QKD-BBM92.vi" Type="VI" URL="../Examples/QKD-BBM92.vi"/>
		</Item>
		<Item Name="Analysis" Type="Folder">
			<Item Name="Inspect VIs" Type="Folder">
				<Item Name="Probability Array.vi" Type="VI" URL="../Analysis/Inspect VIs/Probability Array.vi"/>
				<Item Name="Probability Bar.vi" Type="VI" URL="../Analysis/Inspect VIs/Probability Bar.vi"/>
				<Item Name="Probability - Read.vi" Type="VI" URL="../Analysis/Inspect VIs/Probability - Read.vi"/>
				<Item Name="State Vector Array.vi" Type="VI" URL="../Analysis/Inspect VIs/State Vector Array.vi"/>
				<Item Name="State Vector - Read.vi" Type="VI" URL="../Analysis/Inspect VIs/State Vector - Read.vi"/>
				<Item Name="Bloch Sphere - Read.vi" Type="VI" URL="../Analysis/Inspect VIs/Bloch Sphere - Read.vi"/>
				<Item Name="Bloch Sphere - Display.vi" Type="VI" URL="../Analysis/Inspect VIs/Bloch Sphere - Display.vi"/>
				<Item Name="Reduced Density Matrix Heatmap.vi" Type="VI" URL="../Analysis/Inspect VIs/Reduced Density Matrix Heatmap.vi"/>
				<Item Name="Reduced Density Matrix.vi" Type="VI" URL="../Analysis/Inspect VIs/Reduced Density Matrix.vi"/>
				<Item Name="Full Density Matrix Heatmap.vi" Type="VI" URL="../Analysis/Inspect VIs/Full Density Matrix Heatmap.vi"/>
				<Item Name="Full Density Matrix - Read.vi" Type="VI" URL="../Analysis/Inspect VIs/Full Density Matrix - Read.vi"/>
				<Item Name="Entanglement Table - Display.vi" Type="VI" URL="../Analysis/Inspect VIs/Entanglement Table - Display.vi"/>
				<Item Name="Entanglement Table - Read.vi" Type="VI" URL="../Analysis/Inspect VIs/Entanglement Table - Read.vi"/>
				<Item Name="Von Neumann Entropy.vi" Type="VI" URL="../Analysis/Inspect VIs/Von Neumann Entropy.vi"/>
				<Item Name="Trace.vi" Type="VI" URL="../Analysis/Inspect VIs/Trace.vi"/>
				<Item Name="Qubit Count.vi" Type="VI" URL="../Analysis/Inspect VIs/Qubit Count.vi"/>
			</Item>
			<Item Name="3D Display" Type="Folder">
				<Item Name="QuVI_3D Axis.vi" Type="VI" URL="../Analysis/3D Display/QuVI_3D Axis.vi"/>
				<Item Name="Bloch Sphere Model.vi" Type="VI" URL="../Analysis/3D Display/Bloch Sphere Model.vi"/>
			</Item>
			<Item Name="Calculations" Type="Folder">
				<Item Name="QuVI_Von Neumann Entropy.vi" Type="VI" URL="../Analysis/Calculations/QuVI_Von Neumann Entropy.vi"/>
			</Item>
			<Item Name="Inspect.vi" Type="VI" URL="../Analysis/Inspect.vi"/>
		</Item>
